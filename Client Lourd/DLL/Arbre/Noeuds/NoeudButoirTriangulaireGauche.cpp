...
///
////////////////////////////////////////////////////////////////////////
NoeudButoirTriangulaireGauche::NoeudButoirTriangulaireGauche(const string& typeNoeud)
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudButoirTriangulaireGauche::calculerBornes()
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudButoirTriangulaireGauche::calculerBornes()
{
	if (modele_ != nullptr){
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudButoirTriangulaireGauche::accepterVisiteur(VisiteurAbstrait* visiteur)
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudButoirTriangulaireGauche::accepterVisiteur(VisiteurAbstrait* visiteur)
{
	visiteur->traiterNoeudButoirTriangulaireGauche(this);
}

double NoeudButoirTriangulaireGauche::obtenirEnfoncement(NoeudBille* bille)
{
	bornes.coinMax.z = 0;
	bornes.coinMin.z = 0;
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudButoirTriangulaireGauche::executerCollision(NoeudBille* bille, double dt)
///
/// Cette fonction execute une collision avec l'objet
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudButoirTriangulaireGauche::executerCollision(NoeudBille* bille)
{
	bornes.coinMax.z = 0;
	bornes.coinMin.z = 0;
	double rayon = 1.52*agrandissement_.y;
...
void NoeudButoirTriangulaireGauche::executerCollisionAvecMur(NoeudBille* bille, glm::dvec3 point1, glm::dvec3 point2, double forceAdditionnelle)
{
	...
	if (test.type != aidecollision::COLLISION_AUCUNE)
	{
		...
		bille->assignerVitesse(glm::normalize(normale)*(std::abs(2.0*glm::dot(normale, vitesse)) + forceSupp) + bille->obtenirVitesse());
...
void NoeudButoirTriangulaireGauche::executerCollisionAvecCercle(NoeudBille* bille, glm::dvec3 position, double rayon, double forceAdditionnelle)
{
	double rayonBille = bille->obtenirRayon();
	...
	{
		bille->setCollision(true, true);
		bille->assignerVitesse(normale*std::abs(2.0*glm::dot(normale, vitesse)) + bille->obtenirVitesse());
