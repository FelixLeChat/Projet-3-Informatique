...
////////////////////////////////////////////////////////////////////////
///
/// @fn NoeudPaletteDroit::NoeudPaletteDroit(const std::string& typeNoeud)
///
...
///
////////////////////////////////////////////////////////////////////////
NoeudPaletteDroit::NoeudPaletteDroit(const std::string& typeNoeud)
...
////////////////////////////////////////////////////////////////////////
///
/// @fn NoeudPaletteDroit::~NoeudPaletteDroit()
///
...
///
////////////////////////////////////////////////////////////////////////
NoeudPaletteDroit::~NoeudPaletteDroit()
{
}
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudPaletteDroit::afficherConcret() const
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudPaletteDroit::afficherConcret() const
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudPaletteDroit::calculerBornes()
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudPaletteDroit::calculerBornes()
{
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudPaletteDroit::calculerPoints()
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudPaletteDroit::calculerPoints(){
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudPaletteDroit::calculerSegments()
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudPaletteDroit::calculerSegments()
{
...
///
////////////////////////////////////////////////////////////////////////
void NoeudPaletteDroit::executerCollision(NoeudBille* bille)
{
	if (!NetworkManager::getInstance()->estCompetitif() || bille->obtenirPlayerNum() == playerNum_)
	{
		...
		executerCollisionAvecMur(bille, segments[0][1], segments[0][0], segments[1][0], segments[1][1], forceFrappe);
		executerCollisionAvecCercle(bille, cercles[1], rayons[1], forceFrappe);
		executerCollisionAvecCercle(bille, cercles[0], rayons[0], 0);
	}
}

double NoeudPaletteDroit::obtenirEnfoncement(NoeudBille * bille)
{
	if (NetworkManager::getInstance()->estCompetitif() && bille->obtenirPlayerNum() != playerNum_)
	{
		return 0;
	...
	{
		glm::dvec3 mur = segments[0][0] - segments[0][1];
		glm::dvec3 directionABille{ pos - segments[0][1] };
	...
	enfoncement = obtenirEnfoncementSegment(bille->obtenirPositionRelative(), bille->obtenirRayon(), segments[0][1], segments[0][0]);
	if (enfoncementMax < enfoncement)
		enfoncementMax = enfoncement;
	enfoncement = obtenirEnfoncementSegment(bille->obtenirPositionRelative(), bille->obtenirRayon(), segments[1][1], segments[1][0]);
	if (enfoncementMax < enfoncement)
		enfoncementMax = enfoncement;
	return enfoncementMax;
}

bool NoeudPaletteDroit::obtenirEstDeDroite()
{
	return true;
}
